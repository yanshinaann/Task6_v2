 ...
 */
public class DelaunayTriangulator implements TriangleInt {
...
//    }
    @Override
    public ArrayList<Triangle2D> triangulatePolygone(ArrayList<Point> point)
            throws NotEnoughPointsException {
        pointSet = Utils.pointToVector(point);
        triangleSoup = new TriangleSoup();
        ...
        triangleSoup.removeTrianglesUsing(superTriangle.b);
        triangleSoup.removeTrianglesUsing(superTriangle.c);
        return (ArrayList<Triangle2D>) triangleSoup.getTriangles();
    }
